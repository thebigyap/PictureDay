...
- **Photo viewer navigation**: Left and right arrow buttons stay fixed at the sides of the viewer when zooming and scrolling, matching the behavior of the top toolbar (exit, zoom, reset) instead of scrolling off with the image
